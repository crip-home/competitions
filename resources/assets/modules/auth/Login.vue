  ...
  >
    ...
    >
      <input
          ...
          v-model="credentials.email" placeholder="Enter Your E-Mail Address"
          v-focus="true"
      >
    </form-group>

    <form-group
        id="password" label="Password" :errors="null" :col-lg="6" :col-md="6"
        :col-sm="8"
    >
      <input
    ...
    <submit :col-lg="6" :col-md="6" :col-sm="8">
      ...
      <router-link class="btn btn-link" :to="password_reset">
