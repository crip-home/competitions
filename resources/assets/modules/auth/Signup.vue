<template>
  <form-panel
      :submit="register" title="Register" id="signup"
      class="col-md-8 col-md-offset-2"
  >

    <form-group
        id="name" label="Name" :errors="errors.name" :col-lg="6" :col-md="8"
    >
      <input
          id="name" type="text" class="form-control" name="name" required
          title="Name" v-focus="true" v-model="form.name"
      >
    </form-group>
    ...
    >
      <input
          ...
          title="E-Mail Address" v-model="form.email"
      >
    </form-group>

    <form-group
        id="password" label="Password" :errors="errors.password" :col-lg="6"
        :col-md="8"
    >
      <input
          id="password" type="password" class="form-control" name="password"
          required title="Password" v-model="form.password"
      >
    </form-group>

    <form-group
        id="password_confirmation" label="Confirm Password" :col-lg="6"
        :col-md="8"
    >
      <input
          id="password_confirmation" type="password" class="form-control"
          name="password_confirmation" required title="Confirm Password"
